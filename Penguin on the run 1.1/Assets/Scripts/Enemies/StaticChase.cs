...
public class StaticChase : MonoBehaviour
{
    ...
    //private bool inCHASErange; unused
        ...
        */
        ...
        if (canAttackk)
        {
            if (inATKrange)
            {
                ...
                if (ataqueRapido) { rb.AddForce(ImpulsoATK * Time.deltaTime * -transform.right); }
